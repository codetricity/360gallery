...
def realEstateMain(fileUri, room, imageType="image"):
    """
    Grab main real estate image for hackathon demo
    """
    if fileUri:
        url = request("commands/execute")
        body = json.dumps({"name": "camera.getImage",
        ...
        fileName = "../img/room1.jpg"

        if room == "main":
            fileName = "../img/room1.jpg"
        if room == "room2":
            fileName = "../img/room2.jpg"
        if room == "room3":
            fileName = "../img/room3.jpg"
